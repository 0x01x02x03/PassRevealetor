...
def howto(l):
	...
	# Arreglamos las dirrecciones de directorios para hacer copy/paste
		...
		#Copy/Paste
			#Copy/Paste
			try:
				copis="copy RECUPERAR_ARCHIVOS.rtf " +vari5[0]+'\\'+vari5[1]+'\\'+vari4[1]+'\\'+vari4[2]+'\\'+vari4[3]+'\\'
				try:
				...
				pass
			try:
				copis="copy RECUPERAR_ARCHIVOS.rtf " +vari5[0]+'\\'+vari5[1]+'\\'+vari4[1]+'\\'+vari4[2]+'\\'
				try:
					control=listnoRep.index(copis)
				except (ValueError):
					os.system(copis)
				...
				pass
			try:
				copis="copy RECUPERAR_ARCHIVOS.rtf " +vari5[0]+'\\'+vari5[1]+'\\'+vari4[1]+'\\'
				try:
					control=listnoRep.index(copis)
				except (ValueError):
					os.system(copis)
